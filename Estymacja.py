...
def genetic_algorithm(n_generations=1000, historical_data=None, output_file="Estymacje.csv"):
    """Uruchamia algorytm genetyczny i generuje prognozy na kolejne 10 godzin."""
    last_10_prices = historical_data[-400:]
    ...
    for i in range(10):
        ...
        last_10_prices = np.append(last_10_prices[1:], next_value)
